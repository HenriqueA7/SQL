...
--RETORNA QUANTIDADE DE CIDADES DE CADA ESTADO (APENAS CIDADES QUE TÊM CIDADES CADASTRADAS)
...
--RETORNA TODAS AS CIDADES QUE CONTÉM: "SÃO"
SELECT NOME, ESTADO
FROM CIDADES
WHERE NOME LIKE '%São%';